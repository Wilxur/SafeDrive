...
The following example clones the "[Deploy Vision](https://github.com/Infineon/mtb-example-psoc-edge-ml-deepcraft-deploy-vision)" application with the desired name "DeployVision" configured for the *KIT_PSE84_EVAL_EPC2* BSP into the specified working directory, *C:/mtb_projects*:

   ```
   project-creator-cli --board-id KIT_PSE84_EVAL_EPC2 --app-id mtb-example-psoc-edge-ml-deepcraft-deploy-vision --user-app-name DeployVision --target-dir "C:/mtb_projects"
   ```
