...
*******************************************************************************/
/* RTOS related macros. */
#define TCP_CLIENT_TASK_STACK_SIZE        (1024U * 8U)
#define TCP_CLIENT_TASK_PRIORITY          (1U)
...
int main(void)
{
    ...
    printf("\x1b[2J\x1b[;H");
    printf("****************** "
           "PSOC Edge MCU: Wi-Fi TCP Client "
           "****************** \r\n\n");
    ...
    /* Create the tasks. */
    result = xTaskCreate(tcp_client_task, "Network task", TCP_CLIENT_TASK_STACK_SIZE, NULL,
