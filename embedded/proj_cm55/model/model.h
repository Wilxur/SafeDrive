...
* 
* Generated at 07/06/2026 15:52:32 UTC. Any changes will be lost.
* 
* Model ID  21a6b533-f786-43b3-9a95-eaae812a968c
* 
* Memory    Size                      Efficiency
* Buffers   8 bytes (RAM)             100 %
* State     1434624 bytes (RAM)       100 %
* Readonly  2359456 bytes (Flash)     100 %
* 
* Exported functions:
* 
*  @param data_in images. Input float[224,224,3].
*  @param data_out output_0. Output float[10,1029].
...
// Model GUID (16 bytes)
#define IMAI_MODEL_ID {0x33, 0xb5, 0xa6, 0x21, 0x86, 0xf7, 0xb3, 0x43, 0x9a, 0x95, 0xea, 0xae, 0x81, 0x2a, 0x96, 0x8c}
...
#define IMAI_DATA_IN_BYTES (602112)
...
// data_out [10,1029] (41160 bytes)
#define IMAI_DATA_OUT_RANK (2)
#define IMAI_DATA_OUT_SHAPE ((int[]){1029, 10})
#define IMAI_DATA_OUT_COUNT (10290)
#define IMAI_DATA_OUT_BYTES (41160)
...
// Profiling regions
    ...
    #define IMAI_REGIONS_NAMES {\
    	"SET INPUT 0",\
    	"INVOKE YOLOV5N-SIZE224-BATCH16-EPOCH300_INT8",\
    	"GET OUTPUT 0",\
    }
